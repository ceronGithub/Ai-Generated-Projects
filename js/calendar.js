...
function buildMonthCard(year, month) {
  ...
  analysisBtn.className   = 'month-analysis-btn';
  analysisBtn.textContent = '📊';
  analysisBtn.title       = 'View ' + MONTH_NAMES[month] + ' analysis';
  analysisBtn.style.color = color.accent;
  analysisBtn.style.borderColor = color.light;
  analysisBtn.addEventListener('click', (e) => {
    e.stopPropagation();
    openMonthAnalysis(year, month, color);
  });

  header.appendChild(nameEl);
  header.appendChild(analysisBtn);

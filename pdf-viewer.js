...
document.getElementById('prev-page').onclick = () => pageNum > 1 && renderPage(--pageNum);
document.getElementById('next-page').onclick = () => pageNum < pdfDoc.numPages && renderPage(++pageNum);
